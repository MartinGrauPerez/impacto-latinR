...
plot_01 <- ggplot(data_01, aes(x = tipo_cliente)) +
  ...
  labs(
    title = "Distribución de casos por NPS UN CAMBIO Acá",
...
ggsave("_site/graphs/plot_01.png", plot = plot_01, width = 8, height = 6, dpi = 300)
...
ggsave("_site/graphs/plot_02.png", plot = plot_02, width = 8, height = 6, dpi = 300)
...
ggsave("_site/graphs/plot_03.png", plot = plot_03, width = 8, height = 6, dpi = 300)
...
ggsave("_site/graphs/plot_04.png", plot = plot_04, width = 8, height = 6, dpi = 300)
...
ggsave("_site/graphs/plot_summary_01.png", plot = plot_summary_01, width = 8, height = 6, dpi = 300)
...
ggsave("_site/graphs/plot_summary_02.png", plot = plot_summary_02, width = 8, height = 6, dpi = 300)
